...
#===================================================================        
    ...
    def add_ftp_user(self):
        cmd = f"""
useradd {self.ftp_user} -d {self.ftp_home} -s /usr/sbin/nologin
...
useradd -g sftpgroup -s /usr/sbin/nologin -d /home/sftpuser sftpuser
...
#===================================================================        
    ...
    def chk_sftp_log(self):
        cmd = """
echo '=== SFTP 로그 ==='
tail -50 /var/log/auth.log 2>/dev/null | grep -i sftp || echo 'SFTP 로그가 없습니다.'
"""
        return cmd
...
cp /etc/vsftpd.conf /root/backup/ftp_sftp/vsftpd.conf.backup 2>/dev/null || echo 'FTP 설정 파일 없음'
